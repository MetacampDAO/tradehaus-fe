                        ...
                        <div className="flex items-center justify-start">
                            ...
                            >
                                {/* <img
                                    ...
                                    alt="tradehaus Logo"
                                /> */}
                                <span className="self-center whitespace-nowrap">TradeHaus</span>
                            </a>
                            ...
                            <div className="hidden lg:flex items-center">
                                ...
                                <div className="-mb-1">
                                    <a
                                        ...
                                        href="tradehaus/tradehaus-tailwind-css-dashboard"
                                        data-color-scheme="no-preference: dark; light: light; dark: light;"
                                        data-icon="octicon-star"
                                        data-size="large"
                                        data-show-count="true"
                                        aria-label="Star themesberg/tradehaus-tailwind-css-dashboard on GitHub"
                                    >
                                        Star
                                    </a>
                                </div>
                        ...
                        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                            <div className="flex-1 px-3 bg-white divide-y space-y-1">
                                ...
                                <div className="space-y-2 pt-2">
                                    ...
                                    <a
                                        href="tradehaus/tradehaus-tailwind-css-dashboard/issues"
                                        className="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 group transition duration-75 flex items-center p-2"
                                    >
                                        <svg
                                            className="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
